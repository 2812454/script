...
wget https://raw.githubusercontent.com/2812454/main/PWEB/install/install/pweb > /dev/null 2>&1
chmod 777 pweb > /dev/null 2>&1
clear
[[ ! -d /bin/ppweb ]] && mkdir /bin/ppweb
cd /bin/ppweb || exit
rm *.sh ver* > /dev/null 2>&1
wget https://raw.githubusercontent.com/2812454/main/PWEB/install/verifatt.sh > /dev/null 2>&1
wget https://raw.githubusercontent.com/2812454/main/PWEB/install/verpweb > /dev/null 2>&1
wget https://raw.githubusercontent.com/2812454/main/PWEB/install/verweb > /dev/null 2>&1
...
wget https://raw.githubusercontent.com/2812454/main/PWEB/install/gestorssh.zip > /dev/null 2>&1
...
mv phpMyAdmin-5.2.1-all-languages phpmyadmin > /dev/null 2>&1
chmod -R 0777 phpmyadmin > /dev/null 2>&1
ln -s /usr/share/phpmyadmin /var/www/html/phpmyadmin > /dev/null 2>&1
systemctl restart apache2 > /dev/null 2>&1 
rm phpMyAdmin-5.2.1-all-languages.zip > /dev/null 2>&1
cd /root || exit
}
...
echo -e "                              \033[1;31mFt: ADSVPN\033[1;36m"
echo ""
chave=$(curl -sSL "https://raw.githubusercontent.com/2812454/main/PWEB/install/chave") &>/dev/null
...
echo ""
echo -e "------------------------------------------------------" | lolcat
echo -e "\033[1;36m 🚀PAINEL:\033[1;37m http://$IP/admin\033[0m"
echo -e "\033[1;36m 👤UTILIZADOR:\033[1;37m admin\033[0m"
...
echo -e "\033[1;36m 👤UTILIZADOR:\033[1;37m root\033[0m"
echo -e "\033[1;36m 🔑PASSWORD:\033[1;37m $pwdroot\033[0m"
echo -e "------------------------------------------------------" | lolcat
echo ""
echo -e "\033[1;31m \033[1;33mCOMANDO PRINCIPAL: \033[1;32mpweb\033[0m"
echo -e "\033[1;33m MAIS INFORMAÇÕES \033[1;31m(\033[1;36mTELEGRAM\033[1;31m): \033[1;37mADSVPN\033[0m"
echo ""
